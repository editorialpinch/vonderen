    ...
    <div id="toppanel" class="clearfix">
       ...
       <div id="inner_content">
             <?php// rewind_posts(); query_posts(''); ?>
               ...
               ?>
               <?php if (have_posts()) : while (have_posts()) : the_post(); $ispage = false; ?>
               ...
               { $ispage = true;?>
                ...
                <?php } ?>
               <?php if(post_is_in_descendant_category($lcp_portfolio_id)) 
               { $ispage = true;?>
               <div class="entry">
               <?php if(get_post_meta($post->ID, 'mainimg', true) != ""){ ?>
            ...
            <?php endwhile;
             ...
             <div class="entry">
              <div class="title_holder">
                        ...
                        <h1><a href="<?php the_permalink(); ?>" class="title"><?php echo $lcp_s_nopost_t; ?></a></h1>
                    </div><!--  END "title_holder"  //-->
              <div class="entry_content">
            <p><?php echo $lcp_s_nopost; ?></p>
            </div><!--  END "entry_content"  //-->
            </div>
            <?php endif; ?>
            <?php// wp_reset_query(); ?>
