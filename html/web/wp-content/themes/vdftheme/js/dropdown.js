  ...
  $("#navigation").children("ul").children("li.current_page_item").find("a:first").addClass("main_category_white");
   $("#navigation").children("ul").children("li.current_page_ancestor").find("a:first").addClass("main_category_white");
  // CODE
