	...
	<div class="index-thumb <?=($i&1) ? "right" : "left"?>">
		<div class="thumb-slide">
			<div class="thumb-details">
				<h1 class="videothek-title"><?php echo $page->post_title; ?></h1>
			</div>
...
$(document).ready( function() {
	$('.videothek-title').each(function (){
		//console.log($(this).innerHeight())
		if($(this).innerHeight()!=$('.thumb-image').height() && $.browser.mozilla){
				
				var offset = Math.round(($('.thumb-image').height()-$(this).innerHeight())/2);
				$(this).css('top',offset);
			}
	})
