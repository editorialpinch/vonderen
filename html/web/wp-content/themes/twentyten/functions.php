...
if ( ! function_exists( 'twentyten_posted_in_cat' ) ) :
/**
 * Prints HTML with meta information for the current post (category).
 *
 * @since Twenty Ten 1.0
 */
function twentyten_posted_in_cat() {
	// Retrieves tag list of current post, separated by commas.
...
// shortcode that embeds vimeo video
// to use: [vimvid id="123456" width="730" height="411" color="ffffff"]

function vimvid_func( $atts ) {
...
add_shortcode( 'vimvid', 'vimvid_func' );
