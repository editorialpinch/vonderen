...
?>
    ...
    <div id="container" class="clearfix">
        ...
        <div id="content_wrap">
        <img src="http://www.vonderenfilms.com/web/wp-content/themes/londoncreative/images/vdf_beautiesheader.jpg"/>
             <div id="beauties_inner_content">
<?php 
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////// MAIN LOOP //////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
*/
?>       
            <?php query_posts('post_type=page&post_status=publish&orderby=title&order=ASC&post_parent=345');?>
			<?php if (  $wp_query->have_posts()) : while (have_posts()) : the_post(); ?>
              <div class="beauties" id="post-<?php the_ID();?>">
<?php
// >>>>>>>>>>>>>>>> PORTFOLIO & PAGE POST >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
