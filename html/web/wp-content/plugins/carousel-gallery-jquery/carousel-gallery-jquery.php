...
function carousel_gallery_jquery($output, $attr) {
   ...
   <div class="jcarousel-scroll">
        <a id="mycarousel_319-prev" href="#" class="cgj_prev"><img src="http://www.vonderenfilms.com/web/wp-content/themes/twentyten/images/prev.png"/></a>
        <a id="mycarousel_319-next" href="#" class="cgj_next"><img src="http://www.vonderenfilms.com/web/wp-content/themes/twentyten/images/next.png"/></a>
    </div>
	';
...
function mycarousel_".$post->ID."_itemVisibleInCallback(carousel, item, i, state, evt)
	...
	{
		return \"<div class='cgj_image'><a href='#' rel='nofollow'><img src='\"+item.url+\"' alt='\"+item.title+\"' /></a></div><h2 class='cgj_title'>\" + item.title + \"</h2><p class='caption'>\" + item.caption.replace(/{br}/g, '<br>') + \"</p><p class='description'>\" + item.description.replace(/{br}/g, '<br>') + \"</p>\";
